...
class IceCrystal : Potion() {
    override val id: String = "base:potions:IceCrystal"
    override val assetName: String = "ice_crystal.png"
    ...
    override suspend fun onCombatUse(target: Int?, api: CombatApi) {
        ...
        (1..9).forEach {
            tileOptions.add(Tile.ElementalTile(Suit.ICE, it))
        }
