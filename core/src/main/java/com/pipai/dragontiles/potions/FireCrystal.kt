...
class FireCrystal : Potion() {
    override val id: String = "base:potions:FireCrystal"
    override val assetName: String = "fire_crystal.png"
    ...
    override suspend fun onCombatUse(target: Int?, api: CombatApi) {
        ...
        (1..9).forEach {
            tileOptions.add(Tile.ElementalTile(Suit.FIRE, it))
        }
