...
import com.pipai.dragontiles.artemis.systems.ui.RelicDatabaseUiSystem
import com.pipai.dragontiles.artemis.systems.ui.TooltipSystem
import net.mostlyoriginal.api.event.common.EventSystem

class RelicDatabaseScreen(
    ...
    init {
        val config = WorldConfigurationBuilder()
            ...
            .with(
                -1,
                RelicDatabaseUiSystem(game, stage),
            )
            .with(
                -2,
        ...
        inputProcessor.addAlwaysOnProcessor(world.getSystem(RelicDatabaseUiSystem::class.java))
