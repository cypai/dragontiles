...
import com.pipai.dragontiles.artemis.systems.ui.SealDatabaseUiSystem
import com.pipai.dragontiles.artemis.systems.ui.TooltipSystem
import net.mostlyoriginal.api.event.common.EventSystem

class SealDatabaseScreen(
    ...
    init {
        val config = WorldConfigurationBuilder()
            ...
            .with(
                -1,
                SealDatabaseUiSystem(game, stage),
            )
            .with(
                -2,
        ...
        inputProcessor.addAlwaysOnProcessor(world.getSystem(SealDatabaseUiSystem::class.java))
